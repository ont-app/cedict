...
The DCAT specification is at [`data/cedict-meta.ttl`](https://github.com/ont-app/cedict/blob/master/data/cedict-meta.ttl). It is also part of the [Linked Open Data Cloud](https://lod-cloud.net/#), with [this metadata](https://lod-cloud.net/dataset/http://rdf.naturallexicon.org/zh/ont/Cedict).
